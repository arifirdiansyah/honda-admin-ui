...
export function addDealershipData(dealership) {
    return async (dispatch, getState) => {
        try {
            ...
            const response = await axiosHttp.post(`${process.env.REACT_APP_API_URL}/dealership/add`, dealership);
...
export function updateDealershipData(newDealershipData, dealership) {
    return async (dispatch, getState) => {
        try {
            ...
            await axiosHttp.put(`${process.env.REACT_APP_API_URL}/dealership/update/${dealership.id}`, newDealershipData);
...
export function deleteDealershipData(dealership) {
    return async (dispatch, getState) => {
        try {
            ...
            await axiosHttp.delete(`${process.env.REACT_APP_API_URL}/dealership/${dealership.id}`);
