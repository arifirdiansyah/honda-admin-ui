...
export function addDealershipData(dealership) {
    return async (dispatch, getState) => {
        try {
            ...
            const response = await axios.post(`${process.env.REACT_APP_API_URL}/dealerships/add`, dealership);
...
export function updateDealershipData(newDealershipData, dealership) {
    return async (dispatch, getState) => {
        try {
            ...
            await axios.put(`${process.env.REACT_APP_API_URL}/dealerships/update/${dealership.id}`, newDealershipData);
...
export function deleteDealershipData(dealership) {
    return async (dispatch, getState) => {
        try {
            ...
            await axios.delete(`${process.env.REACT_APP_API_URL}/dealerships/${dealership.id}`);
