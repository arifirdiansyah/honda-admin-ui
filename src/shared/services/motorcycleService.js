...
export function getAllMotorcycle() {
    return async (dispatch, getState) => {
        try {
            ...
            const catalogs = await axiosHttp.get(`${process.env.REACT_APP_API_URL}/motorcycles`);
...
export function addMotorcycleData(motorcycle) {
    return async (dispatch, getState) => {
        try {
            ...
            const response = await axiosHttp.post(`${process.env.REACT_APP_API_URL}/motorcycle/add`, motorcycle);
...
export function updateMotorcycleData(newMotorcycleData, motorcycle) {
    return async (dispatch, getState) => {
        try {
            ...
            const response = await axiosHttp.put(`${process.env.REACT_APP_API_URL}/motorcycle/update/${motorcycle.id}`, newMotorcycleData);
...
export function deleteMotorcycleData(motorcycle) {
    return async (dispatch, getState) => {
        try {
            ...
            await axiosHttp.delete(`${process.env.REACT_APP_API_URL}/motorcycle/${motorcycle.id}`);
